...
if (
  ...
  !document.getElementById("ctx-spin-style")
) {
  const s = document.createElement("style");
  s.id = "ctx-spin-style";
  s.textContent = "@keyframes ctxSpin { to { transform: rotate(360deg); } }";
      ...
      <div>
        ...
        <ToolBtn
          ...
          onClick={() => {
            ...
            success(
              sectionBoxActive ? "Section box disabled." : "Section box enabled.",
            );
          }}
        />
        <ToolBtn
          label={
            highlightOverlap ? "Hide Overlap (green)" : "Highlight Overlap (green)"
          }
